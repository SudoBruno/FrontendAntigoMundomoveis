...
export default function Colors() {
  class SearchTable extends React.Component {
    ...
    render() {
      ...
      return <Table columns={columns} dataSource={color} />;
    }
  }
      ...
      if (id === 0) {
        ...
        try {
          ...
          openNotificationWithIcon(
            ...
            'A cor foi alterado com sucesso'
          );
  ...
  async function handleDeleteFunction(id) {
    try {
      ...
      openNotificationWithIcon(
        ...
        'A cor foi deletado com sucesso'
      );
    } catch (error) {
      openNotificationWithIcon(
        'error',
        'Erro ao deletar',
        'A cor não foi deletado'
      );
    }
  }
