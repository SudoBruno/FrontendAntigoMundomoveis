...
export default function ExpeditionWarehouse() {
  ...
  async function handleRegister(e) {
    ...
    try {
      if (id === 0) {
        try {
          const response = await api.post('expedition/warehouse', data);
        ...
        try {
          const response = await api.put('expedition/warehouse', data);
  ...
  async function handleDeleteFunction(id) {
    try {
      const response = await api.delete(`expedition/warehouse/${id}`);
