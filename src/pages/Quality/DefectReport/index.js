...
export default function ProductionReport() {
    class SearchTable extends React.Component {
        ...
        render() {
            const columns = [
                ...
                {
                    title: 'Data do Defeito',
                    dataIndex: 'defectDate',
                    key: 'defectDate',
                    ...this.getColumnSearchProps('defectDate'),
                },
                {
                    title: 'Linha',
                    dataIndex: 'lineName',
    ...
    const [headers, setHeaders] = useState([
        ...
        { label: 'Data do defeito', key: 'defectDate' },
    ...
    useEffect(() => {
        api.get('production/itemDefect', {}).then((response) => {
    ...
    async function handleDownload() {
        ...
        const response = await api.post('production/itemDefect', data);
    ...
    const csvReport = {
        data: csvData,
        headers: headers,
        filename: `relatorioDeDefeitos${format(new Date(), 'dd-MM-yyyy')}.csv`,
    };
    return (
        <Layout
            style={{
        ...
        >
            <Row style={{ marginBottom: 16 }}>
                ...
                Relatório de Produtos Defeituosos
                            </div>
                        )}
