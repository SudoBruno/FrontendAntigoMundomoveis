...
export default function PlantingDefect() {
  class SearchTable extends React.Component {
    ...
    render() {
      ...
      return <Table columns={columns} dataSource={defects} />;
    }
  }
  ...
  async function Register() {
    try {
      const response = await api.post('plating/defect', { name });
  ...
  async function Edit() {
    try {
      const response = await api.put('plating/defect', { name, id });
      openNotificationWithIcon(
        'success',
        'Sucesso em editar',
        'Editado com sucesso'
  ...
  async function handleDeleteFunction(e) {
    try {
      const response = await api.delete(`plating/defect/${e}`);
      openNotificationWithIcon(
        'success',
        'Sucesso em editar',
        'Editado com sucesso'
