...
export default function FactoryArea() {
  class SearchTable extends React.Component {
    ...
    render() {
      ...
      return <Table columns={columns} dataSource={company} />;
    }
  }
      ...
      if (id === 0) {
        try {
          ...
          openNotificationWithIcon(
            'success',
            'Criado com sucesso',
            'A empresa foi criado com sucesso'
          );
          handleClose();
        } catch (error) {
          openNotificationWithIcon(
  ...
  async function handleDeleteFunction(id) {
    try {
      ...
      openNotificationWithIcon(
        ...
        'A empresa foi deletado com sucesso'
      );
    } catch (error) {
      openNotificationWithIcon(
        'error',
        'Erro ao deletar',
        'A empresa não foi deletado'
      );
    }
  }
    ...
    >
      <Row style={{ marginBottom: 16 }}>
        <Col span={24} align="right">
          <Tooltip title="Criar nova empresa" placement="right">
            <Button
